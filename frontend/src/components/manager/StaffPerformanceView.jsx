...
function ScoreBar({ value, max = 100, color = 'bg-blue-500' }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className="text-xs font-semibold text-gray-700 dark:text-slate-200 w-8 text-right">{value}</span>
    </div>
  );
}
...
export default function StaffPerformanceView() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div>
        <h2 className="text-lg font-bold text-gray-900 dark:text-white">Staff Performance</h2>
        <p className="text-sm text-gray-500 dark:text-slate-400">Individual resolution throughput and quality metrics</p>
      </div>

      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div className="grid grid-cols-[200px_80px_100px_180px_100px_120px] px-5 py-2.5 text-[11px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-wider border-b border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-900">
            ...
            <div key={s.id} className="grid grid-cols-[200px_80px_100px_180px_100px_120px] items-center px-5 py-4 border-b border-gray-100 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
              <div className="flex items-center gap-2.5 min-w-0 pr-2">
                ...
                <div className="min-w-0">
                  <p className="text-sm font-semibold text-gray-800 dark:text-slate-100 truncate">{s.full_name}</p>
