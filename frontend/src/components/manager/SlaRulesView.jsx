      ...
      <div className="grid grid-cols-2 gap-4">
        {loading ? (
          ...
          rules.map(rule => {
            ...
            const c = PRIORITY_COLORS[rule.priority] || 'text-gray-700 dark:text-slate-200 bg-gray-50 dark:bg-slate-900';
            return (
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {!isEditing ? (
                    ...
                    <div className="flex gap-2">
                      <button onClick={() => setEditing(null)} className="px-3 py-1.5 text-xs font-semibold border border-gray-200 dark:border-slate-700 rounded-lg hover:bg-gray-100 dark:bg-slate-700 transition-colors">Cancel</button>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      <input type="number" min="1" value={editing.response_time}
                        ...
                        className="w-full border border-gray-200 dark:border-slate-700 rounded-lg px-3 py-2 text-sm outline-none focus:border-blue-400" />
                    ) : (
