      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
        ...
        {loading ? (
          ...
          data.filter(c => c.total > 0).map(c => {
            ...
            return (
              <div key={c.id} className="grid grid-cols-[1fr_80px_80px_80px_120px] items-center px-5 py-3 border-b border-gray-100 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                ...
                <span className="text-sm font-bold text-emerald-600 dark:text-emerald-400">{c.resolved}</span>
                <span className="text-sm font-bold text-orange-600 dark:text-orange-400">{c.open}</span>
