    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm p-6">
          ...
          <div className="flex justify-between text-xs text-gray-400 dark:text-slate-500 mt-1.5"><span>0%</span><span className="font-semibold text-blue-600">Target: 85%</span><span>100%</span></div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm p-6">
          ...
          <div className="flex justify-between text-xs text-gray-400 dark:text-slate-500 mt-1.5"><span>0%</span><span className="font-semibold text-blue-600">Target: 70%</span><span>100%</span></div>
        </div>
      </div>
