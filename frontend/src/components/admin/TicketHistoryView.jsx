    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center py-12 text-gray-400 dark:text-slate-500 gap-2"><span className="text-3xl">🎫</span><p className="text-sm">No ticket history found</p></div>
        ) : (
          filtered.slice(0, 50).map(t => (
            <div key={t.id} className="grid grid-cols-[140px_1fr_100px_100px_120px_120px_120px] items-center px-5 py-3 border-b border-gray-100 dark:border-slate-700 hover:bg-gray-50 dark:bg-slate-900 transition-colors">
              ...
              <span className={`text-[10px] font-semibold px-2 py-0.5 rounded-full w-fit ${priorityBadge[t.priority] || 'bg-gray-100 dark:bg-slate-700 text-gray-500 dark:text-slate-400'}`}>{t.priority}</span>
