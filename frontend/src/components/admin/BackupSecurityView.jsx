      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm p-6">
          ...
          <div className="flex flex-col gap-3 mb-4 text-xs text-gray-600 dark:text-slate-300">
            <div className="flex items-center justify-between px-3 py-2 bg-gray-50 dark:bg-slate-900 rounded-lg">
          ...
          <button
            ...
            className={`w-full py-2.5 rounded-lg text-sm font-semibold flex items-center justify-center gap-2 transition-all
              ${backupStatus === 'done'    ? 'bg-emerald-500 text-white' :
                backupStatus === 'running' ? 'bg-gray-200 text-gray-500 dark:text-slate-400 cursor-not-allowed' :
