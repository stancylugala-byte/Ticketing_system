  ...
  return (
    <div className="h-screen flex flex-col bg-[#f1f4f9] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4">
        ...
        {/* Shield icon */}
        <div className="w-12 h-12 bg-gray-100 border border-gray-200 rounded-2xl flex items-center justify-center mb-4">
      ...
      <footer className="py-3 border-t border-gray-200 text-center text-xs text-gray-400 shrink-0">
