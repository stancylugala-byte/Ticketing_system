    ...
    <div className={`${sidebarCollapsed ? 'ml-16' : 'ml-60'} h-screen flex flex-col bg-gray-50 dark:bg-slate-900 overflow-hidden transition-all duration-300`}>
      ...
      <header className="h-14 bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 flex items-center px-6 gap-4 shrink-0 shadow-sm">
        ...
        <div className="relative flex-1 max-w-md mx-auto">
          ...
          <input
            className="w-full pl-9 pr-3 py-2 bg-gray-50 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-lg text-sm text-gray-900 dark:text-slate-100 placeholder-gray-400 dark:placeholder-slate-500 outline-none focus:border-blue-500 dark:focus:border-blue-400 transition-all"
            ...
            <ul className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl shadow-xl z-50 max-h-64 overflow-y-auto">
              {results.map(t => (
                <li
                  ...
                  className="flex items-center gap-2 px-4 py-2.5 cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-500/10 border-b border-gray-100 dark:border-slate-700 last:border-none"
                >
                  <span className="text-[10px] font-bold text-blue-600 dark:text-blue-400 w-20 shrink-0">#{t.id.slice(0,8).toUpperCase()}</span>
