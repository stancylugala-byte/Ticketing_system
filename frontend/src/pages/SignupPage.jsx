...
export default function SignupPage() {
  ...
  const inputCls = (field) =>
    `w-full px-3 py-2 border rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-100 placeholder-gray-400 transition-all ${
      fieldErrors[field] ? 'border-red-400' : 'border-gray-200 focus:border-blue-500'
    }`;
    ...
    <div className="h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="w-1/2 flex items-center justify-center bg-[#f1f4f9] px-8 py-4">
          <div className="w-full max-w-[400px] bg-white rounded-2xl shadow-lg border border-gray-100 px-8 py-6">

            <h1 className="text-xl font-extrabold text-gray-900 mb-0.5">Create your account</h1>
            <p className="text-gray-500 text-sm mb-3">Join thousands of teams managing incidents with JavaPA.</p>

            {/* Google */}
            <button type="button" className="w-full py-2 border border-gray-200 rounded-xl flex items-center justify-center gap-2 text-sm font-semibold text-gray-700 hover:bg-gray-50 transition-colors mb-3">
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <span className="text-[10px] text-gray-400 font-semibold tracking-wider">OR REGISTER WITH EMAIL</span>
              <div className="flex-1 h-px bg-gray-200" />
            </div>

            {/* Account type toggle */}
            <div className="flex mb-3 border border-gray-200 rounded-xl overflow-hidden">
            ...
            {error && <div className="mb-3 px-3 py-2 bg-red-50 border border-red-200 rounded-xl text-red-700 text-sm">{error}</div>}
              ...
              <div className="grid grid-cols-2 gap-2.5">
                <div>
                  ...
                  <input id="full_name" name="full_name" type="text" required placeholder="Jane Doe"
                    value={form.full_name} onChange={handleChange} className={inputCls('full_name')} />
                ...
                <div>
                  ...
                  <input id="phone" name="phone" type="tel" placeholder="+1 (555) 000-0000"
                    ...
                    className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 placeholder-gray-400" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input id="password" name="password" type={showPw ? 'text' : 'password'} required
                    ...
                    className={`w-full pl-3 pr-10 py-2 border rounded-xl text-sm outline-none focus:ring-2 focus:ring-blue-100 placeholder-gray-400 ${fieldErrors.password ? 'border-red-400' : 'border-gray-200 focus:border-blue-500'}`} />
                ...
                {form.password && (
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-bold text-gray-400 uppercase shrink-0">{strength.label}</span>
                  </div>
                )}
              </div>
