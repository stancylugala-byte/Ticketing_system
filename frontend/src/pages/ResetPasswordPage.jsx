...
function Check({ pass, label }) {
  return (
    <li className={`flex items-center gap-2 text-xs transition-colors ${pass ? 'text-emerald-600' : 'text-gray-400'}`}>
      <span className={`w-3.5 h-3.5 rounded-full flex items-center justify-center shrink-0 ${pass ? 'bg-emerald-100 text-emerald-600' : 'bg-gray-100 text-gray-400'}`}>
        {pass
    ...
    <div className="min-h-screen flex flex-col bg-[#f1f4f9]">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-10">
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-lg border border-gray-200 px-10 py-10">
          ...
          <h1 className="text-2xl font-extrabold text-gray-900 mb-2 text-center">Reset your password</h1>
          <p className="text-gray-500 text-sm text-center mb-7">Create a strong password that you haven't used before.</p>
            ...
            <div>
              ...
              {form.password.length > 0 && (
                <ul className="mt-2.5 flex flex-col gap-1.5 pl-1">
                  <Check pass={checks.length}    label="At least 8 characters" />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-11 py-3 border rounded-xl text-sm outline-none focus:ring-2 transition-all placeholder-gray-400
